...
Outputs (relative to package root):
    ...
    outputs/figures/Figure4_gap_compression_dual.png      (300 dpi)
    outputs/figures/Figure4_gap_compression_dual.pdf
    outputs/figures/Figure4_gap_compression_consistent.png (300 dpi)
    outputs/figures/Figure4_gap_compression_consistent.pdf
...
def figure_gap_compression_dual(df, yearly_gaps):
    ...
    os.makedirs(FIGURES_DIR, exist_ok=True)
    filepath_png = os.path.join(FIGURES_DIR, 'Figure4_gap_compression_dual.png')
    filepath_pdf = os.path.join(FIGURES_DIR, 'Figure4_gap_compression_dual.pdf')
    fig.savefig(filepath_png, dpi=300, bbox_inches='tight', facecolor='white')
    fig.savefig(filepath_pdf, bbox_inches='tight', facecolor='white')
    print(f"\nSaved: {filepath_png}")
    print(f"Saved: {filepath_pdf}")
...
def figure_gap_compression_consistent(df, yearly_gaps):
    ...
    filepath_png = os.path.join(FIGURES_DIR,
                                'Figure4_gap_compression_consistent.png')
    filepath_pdf = os.path.join(FIGURES_DIR,
                                'Figure4_gap_compression_consistent.pdf')
    fig.savefig(filepath_png, dpi=300, bbox_inches='tight', facecolor='white')
    fig.savefig(filepath_pdf, bbox_inches='tight', facecolor='white')
    print(f"\nSaved: {filepath_png}")
    print(f"Saved: {filepath_pdf}")
